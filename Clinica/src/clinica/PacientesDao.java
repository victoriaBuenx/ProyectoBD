...
public class PacientesDao {
    ...
    public boolean insertarPaciente(String nombre, String apellidoPaterno, String apellidoMaterno,
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al insertar paciente", "Error SQL", JOptionPane.ERROR_MESSAGE);
            //e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean actualizarPaciente(int idPaciente, String nombre, String apellidoPaterno, String apellidoMaterno,
        ...
        try (Connection con = new Conexion().conexion();
            ...
            JOptionPane.showMessageDialog(null, "Error al actualizar paciente", "Error SQL", JOptionPane.ERROR_MESSAGE);
            //e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean eliminarPaciente(int idPaciente) {
        ...
        try (Connection con = new Conexion().conexion();
            ...
            JOptionPane.showMessageDialog(null, "Error al eliminar paciente", "Error SQL", JOptionPane.ERROR_MESSAGE);
            //e.printStackTrace();
            return false;
        }
    } 
    ...
    try (Connection con = new Conexion().conexion();
         PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            modelo.setColumnIdentifiers(new Object[]{
                "ID Pacientes", "Nombre", "Apellido Paterno", "Apellido Materno", "Fecha Nac.", "Teléfono", "Correo", "Fecha Registro"
            });
            ...
            JOptionPane.showMessageDialog(null, "Error al buscar pacientes", "Error SQL", JOptionPane.ERROR_MESSAGE);
            //e.printStackTrace();
        }
    }
